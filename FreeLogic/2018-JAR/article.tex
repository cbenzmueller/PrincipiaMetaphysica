...
\begin{defn}[Evaluation Function for $\FFOL$]
...
\begin{defn}[Henkin model $\map{M}$ for $\FFOL$ model $M$]\label{def:hm}
...
free higher-order logic, the continuation of our formalization studies in
...
Regarding extensions towards free  higher-order logic some first steps
have already been taken \cite{W56,makarenko16:_autom_logik_logik_stufe}.
