...
lemma F2a_1: "cod(dom(x)) \<approx>F dom(x)" sledgehammer nitpick [user_axioms] oops (* no countermodel, no proof *) 
...
lemma F2b_1: "dom(cod(x)) \<approx>F cod(x)" sledgehammer nitpick [user_axioms] oops (* no countermodel, no proof *) 
...
lemma F3a_1: "x\<cdot>dom(x) \<approx>F x" sledgehammer nitpick [user_axioms] oops (* no countermodel, no proof *)
...
lemma F3b_1: "cod(x)\<cdot>x \<approx>F x" sledgehammer nitpick [user_axioms] oops (* no countermodel, no proof *) 
...
lemma Freyd_1: "E(y\<cdot>x) \<^bold>\<leftrightarrow> cod(x) \<approx>F dom(y)" 
 nitpick [user_axioms,mono] oops (* counterexample, why? *)
lemma Freyd_2a: "cod(dom(x)) \<approx>F dom(x)" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
lemma Freyd_2b: "dom(cod(x)) \<approx>F cod(x)" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
lemma Freyd_3a: "x\<cdot>dom(x) \<approx>F x" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
lemma Freyd_3b: "cod(x)\<cdot>x \<approx>F x" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
lemma Freyd_4a: "dom(y\<cdot>x) \<approx>F dom(dom(y)\<cdot>x)" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *)  
lemma Freyd_4b: "cod(y\<cdot>x) \<approx>F cod(y\<cdot>cod(x))" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
lemma Freyd_A5: "x\<cdot>(y\<cdot>z) \<approx>F (x\<cdot>y)\<cdot>z" 
 sledgehammer nitpick [user_axioms,mono] oops (* no counterexample, but also no proof *) 
end 
