...
\isa{{\isasymbox}x}, \isa{x{\isasymbox}} and \isa{x{\isasymcdot}y}. While we do not particularly support the use 
...
that Axiom \isa{A{\isadigit{2}}a} is redundant. For example, the prover Isabelle's internal prover metis 
confirms that \isa{A{\isadigit{2}}a} is already implied by \isa{A{\isadigit{2}}b}, \isa{A{\isadigit{3}}a}, \isa{A{\isadigit{3}}b} 
...
presented next. This proof employs axioms \isa{A{\isadigit{2}}b}, \isa{A{\isadigit{3}}a}, \isa{A{\isadigit{3}}b}, 
\isa{A{\isadigit{4}}a} and \isa{A{\isadigit{5}}}, that is, this proof could be further optimized.%
\end{isamarkuptext}%
\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
we could reduce \isa{A{\isadigit{2}}b} which is implied by \isa{A{\isadigit{1}}}, 
\isa{A{\isadigit{2}}a} and \isa{A{\isadigit{3}}a} as metis proves.%
\end{isamarkuptext}%
\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
\isamarkuptrue%
\isacommand{axiomatization}\isamarkupfalse%
\ FreydsAxiomsReduced\ \isakeyword{where}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \isanewline
...
\ B{\isadigit{5}}{\isacharcolon}\ \ {\isachardoublequoteopen}x{\isasymcdot}{\isacharparenleft}y{\isasymcdot}z{\isacharparenright}\ {\isasymapprox}\ {\isacharparenleft}x{\isasymcdot}y{\isacharparenright}{\isasymcdot}z{\isachardoublequoteclose}\isanewline
\isanewline
\isacommand{lemma}\isamarkupfalse%
