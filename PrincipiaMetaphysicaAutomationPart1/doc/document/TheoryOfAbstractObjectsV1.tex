...
The actuality operator \isa{{\isasymA}} when applied to a formula or propositional formula 
 ...
 \isa{E} (error) or \isa{T} (term), then the syntactical catagory of \isa{{\isasymA}\ {\isasymphi}} 
 is \isa{E} and a dummy entity of appropriate type is returned. This illustrates the very 
