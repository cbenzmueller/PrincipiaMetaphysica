...
\ simp\ \isacommand{oops}\isamarkupfalse%
\ \ \ \ \ \ \ %
\isamarkupcmt{X is \isa{{\isacharparenleft}{\isasymlambda}x\ w{\isachardot}\ Ex\ {\isacharparenleft}exe{\isadigit{1}}\ E\ x{\isacharparenright}{\isacharparenright}\isactrlsup T}%
}
%
\endisatagproof
{\isafoldproof}%
...
\ simp\ \isacommand{oops}\isamarkupfalse%
\ \ \ \ \ \ \ %
\isamarkupcmt{X is \isa{{\isacharparenleft}{\isasymlambda}x\ w{\isachardot}\ {\isasymforall}xa{\isachardot}\ {\isasymnot}\ exe{\isadigit{1}}\ E\ x\ xa{\isacharparenright}\isactrlsup T}%
}
%
\endisatagproof
{\isafoldproof}%
