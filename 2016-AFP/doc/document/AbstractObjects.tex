...
\isanewline
\ \isacommand{abbreviation}\isamarkupfalse%
\ Situation{\isacharcolon}{\isacharcolon}{\isachardoublequoteopen}{\isacharprime}a\ opt{\isasymRightarrow}io\ opt{\isachardoublequoteclose}\ \ \isakeyword{where}\ \isanewline
...
\ \isacommand{abbreviation}\isamarkupfalse%
\ PossibleWorld{\isacharcolon}{\isacharcolon}{\isachardoublequoteopen}{\isacharprime}a\ opt{\isasymRightarrow}io\ opt{\isachardoublequoteclose}\ \isakeyword{where}\ \isanewline
...
\ \isacommand{abbreviation}\isamarkupfalse%
\ Maximal{\isacharcolon}{\isacharcolon}{\isachardoublequoteopen}{\isacharprime}a\ opt{\isasymRightarrow}io\ opt{\isachardoublequoteclose}\ \isakeyword{where}\ \isanewline
