...
The Theory of Abstract Objects distinguishes between encoding properties \isa{{\isasymkappa}\isactrlsub {\isadigit{1}}{\isasymPi}\isactrlsup {\isadigit{1}}} and 
  ...
  form \isa{{\isacharparenleft}enc\ {\isacharparenleft}Q\ y{\isacharparenright}{\isacharparenright}}, where \isa{enc} is uninterpreted constant symbol of appropriate 
  type. Exemplification, noted below as \isa{{\isasymlparr}R\isactrlsup T{\isacharcomma}x\isactrlsup T{\isacharcomma}{\isachardot}{\isachardot}{\isachardot}{\isasymrparr}}, it will mapped to \isa{{\isacharparenleft}exe\ {\isacharparenleft}Q\ y{\isacharparenright}{\isacharparenright}}
